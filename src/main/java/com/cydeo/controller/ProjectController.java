...
public class ProjectController {
    ...
    public ResponseEntity<ResponseWrapper> updateProject(@RequestBody ProjectDTO project){
        ...
        return  ResponseEntity.status(HttpStatus.CREATED).body(new ResponseWrapper("Project is successfully updated", HttpStatus.OK));
    }
    ...
    public ResponseEntity<ResponseWrapper> getProjectByManager(@PathVariable("projectCode") String projectCode){
